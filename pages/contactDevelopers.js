            ...
            <main className={styles.main}>
                ...
                <article className={styles.developers}>
                    <section className={styles.dev}>
                        <h3 className={styles.h3}>Gus Cunningham</h3>
                        <Image 
                    ...
                    <section className={styles.dev}>
                        <h3 className={styles.h3}>Alice Ruppert</h3>
                        <Image 
                    ...
                    <section className={styles.dev}>
                        <h3 className={styles.h3}>Ely Hess</h3>
                        <Image 
                    ...
                    <section className={styles.dev}>
                        <h3 className={styles.h3}>Alia Peterson</h3>
                        <Image 
                    ...
                    <section className={styles.dev}>
                        <h3 className={styles.h3}>Cameron Aragon</h3>
                        <Image 
                    ...
                    <section className={styles.dev}>
                        <h3 className={styles.h3}>Lucas Merchant</h3>
                        <Image 
